...
#--------------------------------------------
# Bot credentials
TG_BOT_TOKEN = os.environ.get("8123510035:AAEIBj22et7OWtTr40M9Ar05wO0PzGZcmzU", "")
APP_ID = int(os.environ.get("35338953", ""))  # Your API ID from my.telegram.org
API_HASH = os.environ.get("6db2fb9625b93d849b8de1682433a2bd", "")   # Your API Hash from my.telegram.org
#--------------------------------------------

CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1003771850255"))  # Your DB channel ID
OWNER = os.environ.get("OWNER", "alexdrvfreak")                   # Owner username without @
OWNER_ID = int(os.environ.get("OWNER_ID", "7202273962"))           # Owner Telegram ID
#--------------------------------------------
